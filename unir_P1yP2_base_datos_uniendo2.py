...
filename2= "COPIA_PANDAS\hdf_lomosP1P2.hdf"
...
df_total=pd.HDFStore(filename2,'a',complib="zlib",complevel=4)
...
max_str_len = 50
df_total.put('data/pollos_estado', pre_p_e2, format='table', data_columns=True, min_itemsize={'Primero': max_str_len, 'Ultimo': max_str_len, 'Pollo': max_str_len, 'Medida': max_str_len, 'Fecha': max_str_len, 'Estado': max_str_len})
df_total.put('data/tabla', datos2 , format='table', data_columns=True)
